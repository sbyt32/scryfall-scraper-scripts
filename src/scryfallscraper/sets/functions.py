...
def scrape_all_sets(zipped: Optional[bool]):
...
def scrape_by_code(set: str, zipped: Optional[bool]):
...
def scrape_by_tcgplayer_id(tcgplayer_id: str, zipped: Optional[bool]):
...
def scrape_by_scryfall_id(scryfall_id: str, zipped: Optional[bool]):
    r"""Scrape set data by TCGPlayer ID: https://scryfall.com/docs/api/sets/tcgplayer
